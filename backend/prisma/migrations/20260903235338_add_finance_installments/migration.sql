...
INSERT INTO "new_FinancialTransaction" ("amount", "categoryId", "clientName", "competenceMonth", "createdAt", "createdById", "description", "dueDate", "id", "notes", "paidAt", "protocolId", "source", "status", "type", "updatedAt") SELECT "amount", "categoryId", "clientName", "competenceMonth", "createdAt", "createdById", "description", "dueDate", "id", "notes", "paidAt", "protocolId", "source", "status", "type", "updatedAt" FROM "FinancialTransaction";
