...
INSERT INTO "new_BillingCharge" ("amount", "barcode", "boletoUrl", "chargeType", "clientId", "contractId", "createdAt", "createdById", "description", "dueDate", "errorMessage", "externalId", "fiscalMode", "id", "installmentNumber", "linhaDigitavel", "nossoNumero", "notes", "paidAmount", "paidAt", "pixCopyPaste", "pixKey", "pixQrCode", "protocolId", "provider", "rawRequest", "rawResponse", "rawWebhook", "sentToClientAt", "status", "totalInstallments", "txid", "updatedAt") SELECT "amount", "barcode", "boletoUrl", "chargeType", "clientId", "contractId", "createdAt", "createdById", "description", "dueDate", "errorMessage", "externalId", "fiscalMode", "id", "installmentNumber", "linhaDigitavel", "nossoNumero", "notes", "paidAmount", "paidAt", "pixCopyPaste", "pixKey", "pixQrCode", "protocolId", "provider", "rawRequest", "rawResponse", "rawWebhook", "sentToClientAt", "status", "totalInstallments", "txid", "updatedAt" FROM "BillingCharge";
